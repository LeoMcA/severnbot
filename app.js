...
function scrape(){
  stations.forEach(function(station){
    ...
    request(url, function(err, res, body){
      ...
      var tweet = '#' + station.name + ': ' + level + 'm at ' + pad(date.getHours()) + ':' + pad(date.getMinutes()) + '; Daily Peak: ' + toSave.peak + 'm at ' + pad(toSave.peakDate.getHours()) + ':' + pad(toSave.peakDate.getMinutes()) + ' #worcesterfloods';
